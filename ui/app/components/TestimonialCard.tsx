export default function TestimonialCard({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
      {/* Rating Stars */}
      <div className="flex items-center gap-2 mb-6">
        ...
        <span className="text-sm text-gray-600 dark:text-gray-400 font-medium">{rating}/5</span>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-gray-500 dark:text-gray-500 text-sm font-medium">{company}</div>
        </div>
      </div>
